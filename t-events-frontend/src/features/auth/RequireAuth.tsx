...
export default function RequireAuth({ children, allowedRoles }: RequireAuthProps) {
  ...
  const isBootstrapping = status === "unknown" || status === "refreshing" || status === "logout_in_progress";
    ...
    return (
      <LiveStatus centered busy>
        <div className="flex flex-col items-center gap-3">
          <div className="h-8 w-8 animate-spin rounded-full border-4 border-neutral-200 border-t-[var(--color-brand-yellow)]" />
