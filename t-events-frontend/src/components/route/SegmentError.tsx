...
export default function SegmentError({
  ...
  message = "Не удалось отобразить страницу. Попробуйте обновить раздел.",
  reset,
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-[var(--color-brand-mist)]">
      <Container>
        <section
          role="alert"
          className="mx-auto flex min-h-[380px] max-w-2xl flex-col items-start justify-center py-16"
        >
